...
class Priority(osv.Model):
    ...
    _columns = {
        ...
        'seq': fields.integer('Priority', help='Low value is the most important', translate=True),
...
class Ticket(osv.Model):
    ...
    _columns = {
        'pirority_id': fields.many2one('anytracker.priority', 'Priority', required=False),
        'seq': fields.function(
